...
function api.answer_callback_query(callback_query_id, text, show_alert, url, cache_time)
    local payload = {
    ...
    local success, res = api.request(config.endpoint .. api.token .. '/answerCallbackQuery', payload)
    return success, res
end
